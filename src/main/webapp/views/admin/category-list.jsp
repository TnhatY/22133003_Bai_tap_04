			...
			<div class="col-first">
				...
				<nav class="d-flex align-items-center">
					...
					<a href="#">Shop<span class="lnr lnr-arrow-right"></span></a> <a
						href="${pageContext.request.contextPath}/admin/sanpham/add">Thêm
						Sản Phẩm</a>
				</nav>
			</div>
		</div>
					...
					<c:forEach items="${listSP}" var="i">
						<div class="col-lg-4 col-md-6">
							<div class="single-product">
								...
								<c:if
									test="${i.hinhanh != null && i.hinhanh.length() >= 5 && i.hinhanh.substring(0, 5) != 'https'}">
									<c:url value="/image?fname=${i.hinhanh}" var="imgUrl"></c:url>
								</c:if>

								<c:if test="${i.hinhanh != null && i.hinhanh.length() >= 5 && i.hinhanh.substring(0, 5) == 'https'}">
									<c:url value="${i.hinhanh }" var="imgUrl"></c:url>
								</c:if>
								...
								<div class="product-details">
									...
									<div class="prd-bottom">
										...
										</a> <a href="/WebJDBC/admin/sanpham2/edit" class="social-info">
											<span class="lnr lnr-sync"></span>
											<p class="hover-text">compare</p>
										</a> <a href="<c:url value='/admin/sanpham/edit?id=${i.id }'/> "
...
<div class="contens1">
	...
	<a href="<c:url value="/admin/category/add"/>" class="button-add">Add Category</a> <br>
