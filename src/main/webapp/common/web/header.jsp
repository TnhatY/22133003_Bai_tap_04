					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown"><a href="#"
								...
								<ul class="dropdown-menu">
									<li class="nav-item"><a class="nav-link"
										href="${pageContext.request.contextPath}/admin/categories">Shop Category</a></li>
									<li class="nav-item"><a class="nav-link"
										href="${pageContext.request.contextPath}/admin/videos">Shop Video</a></li>
									<li class="nav-item"><a class="nav-link"
							...
							<c:choose>
								...
								<c:otherwise>
									<a class="nav-link" href="${pageContext.request.contextPath}/profile">${sessionScope.account.getFullName()}</a>
